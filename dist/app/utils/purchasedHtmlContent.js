...
const purchaseHtmlContent = ({ payload }) => {
    const formattedDate = payload === null || payload === void 0 ? void 0 : payload.paymentDate.toLocaleDateString("en-US", {
        month: "long",
        day: "numeric",
        year: "numeric",
    });
    const totalAmount = (payload === null || payload === void 0 ? void 0 : payload.amount) + (payload === null || payload === void 0 ? void 0 : payload.vat);
    return `
        ...
        <div style="max-width: 400px;  max-height: 550px;  background-color: white; width:100%;  height: 100%; box-sizing: border-box; margin:auto;padding:20px ">
            <div style="text-align: center;">
                ...
                <p style="text-align: center; font-size: 14px; font-weight: 300; color: #6b7280; margin-bottom: 10px;">
                    Thank you for your purchase, ${payload === null || payload === void 0 ? void 0 : payload.name}. Your order is being processed.
                </p>
                ...
                <div style="display: flex; justify-content: space-between; gap: 20px; font-size: 15px; font-weight: 300; margin-top: 6px;">
                    ...
                    <span>${payload === null || payload === void 0 ? void 0 : payload.transaction_Id}</span>
                </div>
                <div style="display: flex; justify-content: space-between; gap: 20px; font-size: 15px; font-weight: 300; margin-top: 6px;">
                    <span>Amount:</span>
                    <span>TK ${payload === null || payload === void 0 ? void 0 : payload.amount.toFixed(2)}</span>
                </div>
                <div style="display: flex; justify-content: space-between; gap: 20px; font-size: 15px; font-weight: 300; margin-top: 6px;">
                    <span>VAT:</span>
                    <span>TK ${payload === null || payload === void 0 ? void 0 : payload.vat.toFixed(2)}</span>
                </div>
                ...
                <div style="text-align: center; margin-top: 20px;">
                    <a href="${payload === null || payload === void 0 ? void 0 : payload.orderStatusLink}" style="background-color: #1669a1; color: white; font-size: 15px; font-weight: 500; padding: 10px; width: 100%; text-align: center; border: none; border-radius: 4px; text-decoration: none; cursor: pointer;">View Order Status</a>
                </div>
          </div>
        </body>
      `;
};
exports.default = purchaseHtmlContent;
